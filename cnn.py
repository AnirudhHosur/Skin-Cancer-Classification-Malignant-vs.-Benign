...
import os
import cv2
print(os.listdir("D:/ML_Projects/Skin Cancer/data/"))

dir = "D:/ML_Projects/Melanoma Classification/skin-lesions/valid/seborrheic_keratosis"
...
def load_data():
    img_dir = "D:/ML_Projects/Skin Cancer/data/train/"
...
def load_data():
    img_dir = "D:/ML_Projects/Skin Cancer/data/test/"
    y_map = {"benign":0, "malignant": 1}
...
y_data_cat_t = tf.keras.utils.to_categorical(y_data_t, num_classes=2)
...
out = keras.layers.Dense(2, activation='sigmoid')(drop3)   #units=1 gives error
...
# Fit the model
history = model.fit(
    x_data, y_data_cat, batch_size=64, epochs=20, validation_data=(x_data_t,y_data_cat_t))
